...
/**
 * 
 * The Class  DpsResponse
 *
 */
public class DpsResponse extends CommonAppResponse{
	...
	/**
	 * Instantiates a new dps response.
	 */
	public DpsResponse() {
	 ...
	 *
	 * @param dpsConsumerSecret the new dps consumer secret
	 */
	 ...
	 *
	 * @param dpsConsumerKey the new dps consumer key
	 */
	 ...
	 *
	 * @param dpsRetryCount the new dps retry count
	 */
	 ...
	 * Sets the rendition.
	 *
	 * @param r the new rendition
	 */
	public void setRendition(String r){
		this.rendition=r;
	}
